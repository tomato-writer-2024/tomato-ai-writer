...
export const BrandIcons = {
  ...
  Writing: ({ size = 24, className = '' }: { size?: number; className?: string }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Membership: ({ size = 24, className = '', level = 'gold' }: { size?: number; className?: string; level?: string }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
      fill="none"
      stroke={level === 'gold' ? '#FFD700' : level === 'silver' ? '#C0C0C0' : '#CD7F32'}
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
      className={className}
  ...
  Quality: ({ size = 24, className = '' }: { size?: number; className?: string }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Export: ({ size = 24, className = '' }: { size?: number; className?: string }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Crown: ({ size = 24, className = '' }: { size?: number; className?: string }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  AI: ({ size = 24, className = '' }: { size?: number; className?: string }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
  ...
  Stats: ({ size = 24, className = '' }: { size?: number; className?: string }) => (
    <svg
      width={size}
      height={size}
      viewBox="0 0 24 24"
