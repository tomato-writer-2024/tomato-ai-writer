...
| 显示收款码 | 微信收款码 | - | `/payment/[id]` | ✅ |
| 扫码支付 | 个人微信支付 | - | 微信App | ✅ |
| 确认支付 | 用户确认 | `/api/payment/[id]/confirm` | `/payment/[id]` | ✅ |
| 会员开通 | 自动升级 | `userManager.upgradeMembership()` | - | ✅ |
| 订单管理 | 查看订单 | `/api/admin/orders` | `/admin/orders` | ✅ |
...
| 订单支付 | `/api/payment/[id]` | ✅ |
| 订单管理 | 订单列表 | `/api/admin/orders` | ✅ |
| 订单导出 | CSV导出 | `/admin/orders` | ✅ |
| 支付确认 | 用户确认 | `/api/payment/[id]/confirm` | ✅ |
...
|-----|------|------|
| 支付宝个人收款 | ⏳ | 支付宝个人收款码 |
| 微信支付商家版 | ⏳ | 需要企业资质，支持自动回调 |
| 支付宝商家版 | ⏳ | 需要企业资质，支持自动回调 |
| 按次付费 | ⏳ | 单次生成付费 |
| API调用 | ⏳ | 企业版API接口 |
| 私有部署 | ⏳ | 定制化部署 |
| 定制训练 | ⏳ | 企业专属模型 |
